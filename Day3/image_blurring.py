...
blur_value = int(input("Enter the value of blur level, 1 is completely blur where as close to 100 is not blur\n"))
if blur_value <= 0 :
    blur_value += 1
...
#Algo
if algo_type == "pca":
    my_algo = pca_class(scaled_face, y, target_names, no_of_elements, blur_value)#here used to be 25 in place of blur_value
